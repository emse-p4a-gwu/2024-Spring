...
<img src="images/bogdan.jpg" width="300">
...
### [Fall 2023 Project Showcase](https://eda.seas.gwu.edu/showcase/2023-fall.html)
...
## `r fa('calendar')` Midterm (weeks 1 - 7) on March 07

## `r fa('calendar')` Final (weeks 1 - 14) on May 09
...
# [AI Policy](https://p4a.seas.gwu.edu/2024-Spring/syllabus.html#use-of-chatgpt-and-other-ai-tools)
...
## `r fa('slack')` Use [Slack](https://emse-p4a-s24.slack.com/) to ask questions.
...
# `r fa('hard-drive')` [Course Software](https://p4a.seas.gwu.edu/2024-Spring/software.html)

<br>

--

## `r fa('slack')` [Slack](https://emse-p4a-s24.slack.com/): Install app & **turn notifications on**!
...
## `r fa('hard-drive')` Install [course software](https://p4a.seas.gwu.edu/2024-Spring/software.html) if you haven't
...
# Go to the [schedule](https://p4a.seas.gwu.edu/2024-Spring/schedule.html)
