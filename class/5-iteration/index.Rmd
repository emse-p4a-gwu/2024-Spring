...
# Please don't copy-paste from ChatGPT
...
kthDigit <- function(x, k) {
  ...
  if (k <= nchar(x_str)) {
    return(as.numeric(substr(x_str, nchar(x_str) - k + 1, nchar(x_str) - k + 1)))
  } else {
    return(0)
  }
}
...
## And you lose the chance to think 😞
...
In your practice file, you have the solution for the function `isMultipleOf4Or7(n)`, which returns `TRUE` if `n` is a multiple of 4 or 7 and `FALSE` otherwise.
...
# [HW 5](https://p4a.seas.gwu.edu/2024-Spring/hw/5-iteration.html)
